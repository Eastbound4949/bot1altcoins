...
SYMBOLS  = os.environ.get("SYMBOLS",  "XRPUSDT,LTCUSDT,LINKUSDT,ATOMUSDT,NEARUSDT,APTUSDT,ARBUSDT,OPUSDT,FILUSDT,ICPUSDT,ETCUSDT,XLMUSDT,ALGOUSDT,VETUSDT,SANDUSDT,AAVEUSDT,RUNEUSDT,INJUSDT,TIAUSDT,SUIUSDT,SEIUSDT,TRXUSDT,HBARUSDT,CRVUSDT,LDOUSDT,DYDXUSDT,GRTUSDT,WLDUSDT").split(",")
